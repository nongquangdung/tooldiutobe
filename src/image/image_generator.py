...
class ImageGenerator:
    def __init__(self):
        ...
        if not api_key or api_key == 'sk-test-key-replace-with-real-key':
            self.client = None
            print("⚠️  Chưa cấu hình OpenAI API key cho tạo ảnh")
        else:
    ...
    def generate_image_dalle(self, prompt, size="1024x1024"):
        ...
        try:
            ...
            return {"success": False, "error": f"Lỗi tạo ảnh DALL-E: {str(e)}"}
    ...
    def download_image(self, url, save_path):
        ...
        try:
            ...
            return {"success": False, "error": f"Lỗi tải ảnh: {str(e)}"}
    ...
    def resize_image_for_video(self, image_path, target_size=(1920, 1080)):
        ...
        try:
            ...
            return {"success": False, "error": f"Lỗi resize ảnh: {str(e)}"}
    ...
    def load_custom_image(self, source_path, save_path):
        ...
        try:
            ...
            return {"success": False, "error": f"Lỗi tải ảnh thủ công: {str(e)}"}
    ...
    def validate_image_file(self, file_path):
        ...
        try:
            ...
            return {"valid": False, "error": f"Lỗi kiểm tra ảnh: {str(e)}"} 
=======
import openai
import os
import requests
