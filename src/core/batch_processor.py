...
if __name__ == "__main__":
    ...
    print("[EMOJI] Smart Batch Processor initialized successfully!")
    print(f"   [USERS] Max Workers: {processor.max_workers}")
    print(f"   [FOLDER] Supported Formats: {detector.SUPPORTED_FORMATS}") 