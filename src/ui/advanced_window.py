...
"""
    ...
    def populate_character_settings_table(self):
        ...
        for i, character in enumerate(characters):
            ...
            preview_layout.addStretch()
            self.character_settings_table.setCellWidget(i, 9, preview_widget)
    ...
    def update_character_emotion_from_input(self, char_id, text):
        ...
        if text.strip():  # Only update if text is not empty
            ...
            # 🎯 AUTO-MAP EMOTION TO PARAMETERS: Tự động cập nhật exaggeration và cfg_weight
            ...
            print(f"🎭 Emotion changed for {char_id}: {emotion_text}")
            print(f"   ✨ Auto-adjusted: exaggeration={exaggeration:.2f}, cfg_weight={cfg_weight:.2f}")
