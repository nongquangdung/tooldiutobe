...
class QualityMetricsWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        # Success Rate
        success_group = QGroupBox("[TARGET] Success Rate")
        ...
        quality_group = QGroupBox("[STATS] Avg Quality Score")
        ...
        # Candidates Needed
        candidates_group = QGroupBox("[REFRESH] Avg Candidates Needed")
        ...
        # Total Tasks
        tasks_group = QGroupBox("[CLIPBOARD] Total Tasks")
...
class QualityConfigWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        # Quality Threshold
        threshold_group = QGroupBox("[TARGET] Quality Control Settings")
        ...
        weights_group = QGroupBox("[EMOJI] Quality Metrics Weights")
...
class QualityTab(QWidget):
    ...
    def setup_ui(self):
        ...
        # Header
        header_label = QLabel("[TARGET] QUALITY CONTROL DASHBOARD")
        ...
        # Real-time log
        log_group = QGroupBox("[CLIPBOARD] Real-time Quality Log")
        log_layout = QVBoxLayout()
        self.quality_log = QTextEdit()
        self.quality_log.setMaximumHeight(200)
        self.quality_log.setPlainText(
            "2024-01-15 10:30:15 - [OK] Task demo_001: Generated 5 candidates, best score: 0.92\n"
            "2024-01-15 10:30:32 - [OK] Task demo_002: Generated 3 candidates, best score: 0.87\n"
            "2024-01-15 10:30:45 - [WARNING] Task demo_003: Quality threshold not met, retrying...\n"
            "2024-01-15 10:30:58 - [OK] Task demo_003: Generated 7 candidates, best score: 0.89\n"
        )
        ...
        tab_widget.addTab(metrics_tab, "[STATS] Metrics")
        ...
        # Apply button
        apply_btn = QPushButton("[OK] Apply Quality Settings")
        apply_btn.clicked.connect(self.apply_quality_settings)
        config_layout.addWidget(apply_btn)
        
        config_tab.setLayout(config_layout)
        tab_widget.addTab(config_tab, "[CONFIG] Configuration")
        ...
        tab_widget.addTab(candidates_tab, "[SEARCH] Candidates")
        ...
        self.whisper_status_label = QLabel("[EMOJI] Whisper: Ready")
        status_layout.addWidget(self.whisper_status_label)
        
        self.controller_status_label = QLabel("[TARGET] Controller: Active")
    ...
    def apply_quality_settings(self):
        ...
        log_entry = f"{timestamp} - [CONFIG] Quality settings updated: threshold={settings['quality_threshold']:.2f}\n"
